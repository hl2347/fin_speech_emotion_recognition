...
history=model.fit(training_generator, epochs=50, validation_data=validation_generator, callbacks=[rlrp], use_multiprocessing=True, workers=16)
...
model.save("consolidtaed_trainable_model")
