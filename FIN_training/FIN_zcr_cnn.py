...
from keras.layers import Dense, Conv1D, MaxPooling1D, Flatten, Dropout, BatchNormalization, ReLU
...
#zcr
model=Sequential()
model.add(Conv1D(4, kernel_size=2, strides=1, padding='valid', activation='softsign', input_shape=(2048, 1)))
model.add(ReLU())
model.add(Flatten())
