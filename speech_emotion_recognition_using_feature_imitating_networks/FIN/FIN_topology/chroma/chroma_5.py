...
label_base_directory = "../../frame_features/chroma/"
...
#chroma model
model=Sequential()
model.add(Conv1D(256, kernel_size=512, strides=1, padding='valid', activation='relu', input_shape=(2048, 1)))
model.add(MaxPooling1D(pool_size=256, strides = 128, padding = 'valid'))
model.add(Flatten())
...
print("oob var_weighted: "+  str(oob(test_label,pred,None)))
