...
#rms model
model=Sequential()
model.add(Conv1D(256, kernel_size=5, strides=1, padding='valid', activation='relu', input_shape=(2048, 1)))
model.add(MaxPooling1D(pool_size=5, strides = 2, padding = 'valid'))

model.add(Conv1D(256, kernel_size=5, strides=1, padding='valid', activation='relu'))
model.add(MaxPooling1D(pool_size=5, strides = 2, padding = 'valid'))
...
model.add(Conv1D(64, kernel_size=5, strides=1, padding='valid', activation='relu'))
model.add(MaxPooling1D(pool_size=5, strides = 2, padding = 'valid'))
...
print("r squared value variance weighted: " + str(r2_score(test_label, pred,multioutput='variance_weighted')))
