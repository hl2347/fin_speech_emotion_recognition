...
#load model
model=load_model("FIN_mfcc_training_full_dataset")
...
label_base_directory = "../../new_dataset_frame_features/mfcc/"
...
print("oob 10: "+  str(oob(train_label,pred,10)))
print("oob 5: "+  str(oob(train_label,pred,5)))
print("oob 1: "+  str(oob(train_label,pred,1)))
