...
if hvd.rank() == 0:
    ...
    hist.to_csv("consolidated_uninitialized.csv",index=False)
    ...
    plt.savefig("consolidated_uninitialized_loss_curve.png")
    model.save("consolidated_uninitialized")
    ...
    df.to_csv("conosolidated_model_uninitialized_confusion_matrix_data.csv",index=False)
