...
if hvd.rank() == 0:
    ...
    hist.to_csv("consolidated_untrainable_log.csv",index=False)
    ...
    plt.savefig("consolidated_untrainable.png")
    model.save("consolidated_untrainable")
    ...
    df.to_csv("conosolidated_model_untrainable_confusion_matrix_data.csv",index=False)
    ...
    plt.savefig("consolidated_untrainable_confusion_matrix.png")
